...
Revision ID: baa5b1cecbe9
Revises: 
Create Date: 2026-08-05 02:12:26.385630
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('OWNER', 'ADMIN', 'MANAGER', 'TECHNICIAN', 'SUPPORT', 'CASHIER', name='userrole'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
